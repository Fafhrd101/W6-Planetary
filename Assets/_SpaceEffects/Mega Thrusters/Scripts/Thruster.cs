...
public class Thruster : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        thrAudio = GetComponentInParent<AudioSource>();
        //print("Using "+thrAudio.gameObject.name+ " for Ship Audio");
    ...
    // {
    //     //thrAudio.volume = MusicController.Instance.globalSoundVolume;
    //     switch(thrusterSound)
    //     {
    //         // Don't fuck with what's already set
