    ...
    public class F3DAudioController : MonoBehaviour
    {
        ...
        public void SeekerShot(Vector3 pos)
        {
            if (timer_01 >= seekerDelay)
            {
                ...
                if (aSrc != null)
                {
                    ...
                    aSrc.volume = Random.Range(0.8f, 1f);
                    aSrc.volume = Mathf.Min(aSrc.volume, MusicController.Instance.globalSoundVolume);
                    aSrc.minDistance = 8f;
                    aSrc.loop = false;
        ...
        public void PlasmaBeamLoop(Vector3 pos, Transform loopParent)
        {
            ...
            if (aOpen != null && aLoop != null)
            {
                ...
                aOpen.volume = Mathf.Min(aOpen.volume, MusicController.Instance.globalSoundVolume);
                ...
                aLoop.volume = Mathf.Min(aLoop.volume, MusicController.Instance.globalSoundVolume);
                aLoop.loop = true;
        ...
        public void PlasmaBeamClose(Vector3 pos)
        {
            ...
            if (aClose != null)
            {
                ...
                aClose.volume = Mathf.Min(aClose.volume, MusicController.Instance.globalSoundVolume);
