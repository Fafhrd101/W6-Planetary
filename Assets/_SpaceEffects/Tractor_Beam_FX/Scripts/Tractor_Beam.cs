...
public class Tractor_Beam : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tractorBeamAudio.volume = MusicController.Instance.globalSoundVolume;
    ...
    void Update()
    {
        ...
        {
            // TODO ships invulnerable when inside tractor beam
    ...
    {
        // Does this kill bullets, thus making ship invulnerable?
        if (other.gameObject.GetComponent<Projectile>() != null)
            Destroy(other.gameObject);
        
        insideTractorBeam = true;
        tractorBeamLockedAudio.volume = MusicController.Instance.globalSoundVolume;
