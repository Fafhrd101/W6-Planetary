...
public class Assassination : Mission {
    ...
    public override void OnMissionStarted()
    {
        ...
        Target = SectorNavigation.GetJumpgates()[0].
            GetComponent<ShipSpawner>().SpawnMissionTarget(ObjectFactory.Instance.Factions[1]);    // TODO - spawns NPC faction ships
    ...
    public override void RegisterKill(Ship kill)
    {
        ...
        {
            ConsoleOutput.PostMessage("Mission completed! Your payment of " + Payout * 3 + " credits will be transferred now.", Color.blue);
            Progression.MissionCompleted();
            Player.Instance.credits += Payout*3;
