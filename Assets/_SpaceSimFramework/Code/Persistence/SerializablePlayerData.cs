...
public class SerializablePlayerData
{
    ...
    public SerializableVector2 previousSector;
    public SerializableVector3 previousPosition;
    public SerializableVector3[] Kills;
    ...
    public static SerializableMissionData FromMission()
    {
        ...
        if (MissionControl.CurrentJob.Type == Mission.JobType.Patrol)
        {
            data.JobData.Add(new KeyValuePair<string, object>(
                "KillCount",
                new SerializableVector3(((Patrol)MissionControl.CurrentJob).Kills.x, ((Patrol)MissionControl.CurrentJob).Kills.y, ((Patrol)MissionControl.CurrentJob).Kills.z))
            );
        }
...
public class SerializablePlayerShip
{
    ...
    //         {
    //             shipModel.Equipment[w_i] = item.name;
    //         }
    //     }
    //     else
    //     {
