...
public enum CommoditiesCreationMethod
{
    Grown,
    Mined,          // Ores+ first stage
    Manufactured,
    Collected,      // Natural resources
    Refined         // Ores+ second stage
}
...
public class Commodities: SingletonScriptableObject<Commodities> {
    ...
    public class WareType
    {
        ...
        public CommoditiesCreationMethod creationMethod;
        public Sprite icon;         // Moving away from IconManager thinking...
