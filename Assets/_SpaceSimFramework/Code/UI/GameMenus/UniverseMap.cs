...
public class UniverseMap : MonoBehaviour {
    ...
    public ScrollTextController _sectorDetailsPanel;
    ...
    private void Start()
    {
        ...
        foreach(SerializableUniverseSector sector in Universe.Sectors.Values)
        {
            ...
            if (IsKnownSector(sector.SectorPosition)) {
                ...
                sectorIcon.GetComponentInChildren<TMP_Text>().text = sector.SectorPosition.ToString();
    ...
    private void UpdateSectorText()
    {
        ...
        if (Knowledge.ContainsKey(_selectedSector.SectorPosition))
        {
            ...
            _sectorDetailsPanel.AddMenuItem("",false, Color.white);
        ...
        {
            _sectorDetailsPanel.AddMenuItem("Unknown sector", false, Color.white);
        }
    }
    ...
    private Vector2 WorldToMapPosition(Vector2 sectorCoords)
    {
        ...
        return new Vector2(mapDimensions.x / 2 * sectorCoords.x / MapSize-MapContainer.rect.width/3, mapDimensions.y / 2 * sectorCoords.y / MapSize-MapContainer.rect.width/3);
    }
